...
const (
	JSONRPCMethodGetBalance_Client          = "get_balance"
	JSONRPCMethodRollbackTransaction_Client = "rollback_transaction"
	JSONRPCMethodWithdrawAndDeposit_Client  = "withdraw_and_deposit"
)
